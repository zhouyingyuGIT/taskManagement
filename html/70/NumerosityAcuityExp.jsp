...
<input type=hidden value="IndependentWebPage/175/70/NumerosityAcuityF.jsp" name="redirect" id="redirect"/>
...
function get_all_coid()
{
	...
	document.getElementById("test_href").setAttribute("href","NumerosityAcuityF.jsp?sumitcoids="+temp.join(";"));
