...
function init_task()
{
	...
	{
		if(result[pos-1][0] === answer[pos-1][0] && result[pos-1][1] === answer[pos-1][1] && result[pos-1][2] === answer[pos-1][2]){
			// document.getElementById("reward").classList.remove("hide");
			$("#reward").text("正确！能否再快一些！");
...
<input type="button" value="确定" onclick="init_task()" />
</div>
</body>
